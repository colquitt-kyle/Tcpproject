...
public class TCPServer {
    ...
    long all = 0;
    long average = 0;
    File originalFile = new File("/Users/kyle6/Desktop/Test1 - large.txt");
    public void readFile() throws Exception{
        ...
        try {
            ...
            while (true) {
                ...
                InputStream is;
                fos = new FileOutputStream("/Users/kyle6/Desktop/new/Test1 - large" +nTimes+ ".txt");
                ...
                // Closing
                is.close();
                File newFile = new File("/Users/kyle6/Desktop/new/Test1 - large" +nTimes+ ".txt");
